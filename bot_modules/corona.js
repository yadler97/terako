...
${(`${data[0].attributes.county.replace('SK', 'Stadt').replace('LK', 'Landkreis')} (${getStateAbbreviation(data[0].attributes.BL)})${Array(40).join(' ')}`).substring(0, 40)}${parseFloat(data[0].attributes.cases7_per_100k).toLocaleString(envLang, { minimumFractionDigits: 1, maximumFractionDigits: 1 })}\n\
${(`${data[1].attributes.county.replace('SK', 'Stadt').replace('LK', 'Landkreis')} (${getStateAbbreviation(data[1].attributes.BL)})${Array(40).join(' ')}`).substring(0, 40)}${parseFloat(data[1].attributes.cases7_per_100k).toLocaleString(envLang, { minimumFractionDigits: 1, maximumFractionDigits: 1 })}\n\
${(`${data[2].attributes.county.replace('SK', 'Stadt').replace('LK', 'Landkreis')} (${getStateAbbreviation(data[2].attributes.BL)})${Array(40).join(' ')}`).substring(0, 40)}${parseFloat(data[2].attributes.cases7_per_100k).toLocaleString(envLang, { minimumFractionDigits: 1, maximumFractionDigits: 1 })}\n\
${(`${data[3].attributes.county.replace('SK', 'Stadt').replace('LK', 'Landkreis')} (${getStateAbbreviation(data[3].attributes.BL)})${Array(40).join(' ')}`).substring(0, 40)}${parseFloat(data[3].attributes.cases7_per_100k).toLocaleString(envLang, { minimumFractionDigits: 1, maximumFractionDigits: 1 })}\n\
${(`${data[4].attributes.county.replace('SK', 'Stadt').replace('LK', 'Landkreis')} (${getStateAbbreviation(data[4].attributes.BL)})${Array(40).join(' ')}`).substring(0, 40)}${parseFloat(data[4].attributes.cases7_per_100k).toLocaleString(envLang, { minimumFractionDigits: 1, maximumFractionDigits: 1 })}\`\`\`\n\
            `);
        }
    });
    request.send();
